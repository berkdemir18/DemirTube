...
const css = `:host{all:initial;position:fixed;right:18px;bottom:18px;z-index:2147483647}.dt-shorts-dock{font:13px/1.4 Inter,Roboto,Arial,sans-serif}.dt-shorts-dock summary{display:flex;align-items:center;gap:7px;width:max-content;padding:7px 11px 7px 7px;border:1px solid rgba(255,255,255,.09);border-radius:999px;background:#0f0f0f;color:#E7E6E3;font-weight:750;cursor:pointer;box-shadow:0 8px 26px #0008}.dt-shorts-dock summary svg{border-radius:5px}.dt-shorts-dock>div{display:grid;gap:6px;width:205px;margin-top:8px;padding:10px;border:1px solid rgba(255,255,255,.09);border-radius:11px;background:#161615;color:#E7E6E3;box-shadow:0 12px 35px #0009}.dt-shorts-dock strong{font-size:12px}.dt-shorts-dock button{border:1px solid rgba(255,255,255,.09);border-radius:7px;background:#1d1d1c;color:#E7E6E3;padding:7px;text-align:left;cursor:pointer}.dt-shorts-dock button:hover{border-color:#C0522F}.dt-shorts-dock button svg{vertical-align:middle;margin-right:4px}`;
